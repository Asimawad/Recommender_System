...
import polars as pl
import os
# The data Structure + Helper Fucntions
import Helper_Functions
# experiment_folder = "Experiments/32_million_trials/K_30_n_Epochs_40_lmbd_1_gamma_0.1_taw_10/"
experiment_folder = "Experiments/32_million_trials/a/32_million_trial1/"
...
# ratings = pl.read_csv("ml-32m/ratings.csv")
# train_df,test_df,user_idx_map,  movie_idx_map ,idx_to_user,idx_to_movie =  Helper.create_train_test_df(ratings)
# print(train_df.head())
# # Load movie titles
...
# # Helper.save_idx_maps(experiment_folder,user_idx_map,  movie_idx_map ,idx_to_user,idx_to_movie)


user_idx_map,  movie_idx_map ,idx_to_user,idx_to_movie  = Helper.Load_idx_maps(f"{experiment_folder}/model_params/")
movies_factors,users_factors,user_bias,item_bias = Helper.load_model(experiment_folder)
